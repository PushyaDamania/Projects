...
/**
 * This is the controller that handles /login URL
 */
@Controller
        ...
        @RequestParam("password") String password) {
            ...
            try {
                ...
                String message = URLEncoder
                        .encode("Authentication failed. Please try again.", StandardCharsets.UTF_8);
            ...
            if (isAuthenticated) {
                ...
                String message = URLEncoder
                        .encode("Invalid username or password. Please try again.", StandardCharsets.UTF_8);
                return "redirect:/login?error=" + message;
            }
        }
}